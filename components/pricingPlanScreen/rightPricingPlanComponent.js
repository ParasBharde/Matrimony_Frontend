...
const RightPricingPlanComponent = (props) => {
  ...
  return (
    <div className='bg-white py-5 px-14 rounded-lg max-md:w-full max-md:text-center max-md:text-2xl'>
                ...
                <p className='mb-3'><i className="fa-solid text-main fa-circle-check"></i><span className='font-[400] text-[12px] ml-2'>{props.pricing.pricing_plan2_point2} </span></p>
                <p className='mb-3'><i className="fa-solid text-main fa-circle-check"></i><span className='font-[400] text-[12px] ml-2'>{props.pricing.pricing_plan2_point3}</span></p>
