...
const ContactInformation = () => {
  return (
    <div className="grid grid-cols-12 gap-10 my-10">
      <div className="grid col-span-6 max-md:col-span-12 object-fill max-sm:col-span-12">
        <Image src={contactInfo} alt="Contact Info" />
      </div>
      <div className="grid col-span-6 max-md:col-span-12 flex-wrap max-sm:col-span-12 mx-9">
        <p className="text-dark text-[30px] font-semibold ">
          Contact Information
        </p>
        <div className="flex  items-center mt-5 ">
