...
.catch(function (error) {
  ...
  return (
    ...
    <div className='mt-7 lg:w-[400px] sm:w-[300px] w-[90%]'>
        ...
        <input value={email} onChange={(e)=>{setEmail(e.target.value)}} placeholder='Enter Your Email' className='border border-[#E1E1E1] lg:w-[400px] sm:w-[300px] w-[100%] py-2 px-8 rounded-md'/>
    </div>
    <div className='mt-3 lg:w-[400px] sm:w-[300px] w-[90%] '>
        <p className='text-dark font-[500] text-[14px]'>Password*</p>
        <input value={password} onChange={(e)=>{setPassword(e.target.value)}} placeholder='Enter Your Password' type={"password"} className='border border-[#E1E1E1] lg:w-[400px] sm:w-[300px] w-[100%] py-2 px-8 rounded-md'/>
    </div>
