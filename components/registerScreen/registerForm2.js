      ...
      <div className='flex justify-center items-center gap-5'>
        <div>
          <div className='mt-5 max-w-min mx-auto'>
            ...
            <input placeholder='Enter Your First Name' value={firstName} onChange={(e) => { setFirstName(e.target.value) }} type={"text"} className='border border-gray-400 w-[400px] py-2 px-8 rounded-md mb-3' />
          </div>
          ...
          <div className='mt-5 max-w-min mx-auto'>
            ...
            <input value={dateOfBirth} onChange={(e) => { setDateOfBirth(e.target.value) }} type={"date"} className='border border-gray-400 w-[400px] py-2 px-8 rounded-md mb-3' />
          </div>
          <div className='mt-5 max-w-min mx-auto'>
            <p className='text-dark font-[500] text-[14px] mb-2'>Height *</p>
            <input placeholder='Enter Height' type={"number"} value={height} onChange={(e) => { setHeight(e.target.value) }} className='border border-gray-400 w-[400px] py-2 px-8 rounded-md mb-3' />
          </div>
          <div className='mt-5 max-w-min mx-auto'>
            <p className='text-dark font-[500] text-[14px] mb-2'>Educational Qualification *</p>
            <input placeholder='Enter Your Educational Qualifications' type={"text"} value={educationalQualifications} onChange={(e) => { setEducationalQualifications(e.target.value) }} className='border border-gray-400 w-[400px] py-2 px-8 rounded-md mb-3' />
          </div>

          <div className='mt-5 max-w-min mx-auto'>
            <p className='text-dark font-[500] text-[14px] mb-2'>Salary / Monthly Earnings *</p>
            <input placeholder='Enter Your Salary' type={"number"} value={salary} onChange={(e) => { setSalary(e.target.value) }} className='border border-gray-400 w-[400px] py-2 px-8 rounded-md mb-3' />
          </div>
          <div className='mt-5 max-w-min mx-auto'>
            <p className='text-dark font-[500] text-[14px] mb-2'>Expectation *</p>
            <input placeholder='Enter Your Expectation' type={"text"} value={expectation} onChange={(e) => { setExpectation(e.target.value) }} className='border border-gray-400 w-[400px] py-2 px-8 rounded-md mb-3' />
          </div>
          <div className='mt-5 max-w-min mx-auto'>
            <p className='text-dark font-[500] text-[14px] mb-2'>Caste *</p>
            <input placeholder='Enter Your Caste' type={"text"} value={caste} onChange={(e) => { setCaste(e.target.value) }} className='border border-gray-400 w-[400px] py-2 px-8 rounded-md mb-3' />
          </div>
        ...
        <div>
          ...
          <div className='mt-5 max-w-min mx-auto'>
            ...
            <input placeholder='Enter Your Last Name' type={"text"} value={lastName} onChange={(e) => { setLastName(e.target.value) }} className='border border-gray-400 w-[400px] py-2 px-8 rounded-md mb-3' />
          </div>
          ...
          <div className='mt-5 max-w-min mx-auto'>
            ...
            <input placeholder='Enter Your Color' type={"text"} value={color} onChange={(e) => { setColor(e.target.value) }} className='border border-gray-400 w-[400px] py-2 px-8 rounded-md mb-3' />
          </div>
          <div className='mt-5 max-w-min mx-auto'>
            <p className='text-dark font-[500] text-[14px] mb-2'>Career Details *</p>
            <input placeholder='Enter Your Career Details' type={"text"} value={careerDetails} onChange={(e) => { setCareerDetails(e.target.value) }} className='border border-gray-400 w-[400px] py-2 px-8 rounded-md mb-3' />
          </div>


          <div className='mt-5 max-w-min mx-auto'>
            <p className='text-dark font-[500] text-[14px] mb-2'>Family Property Details *</p>
            <input placeholder='Enter Your Family Property Details' type={"text"} value={familyPropertyDetails} onChange={(e) => { setFamilyPropertyDetails(e.target.value) }} className='border border-gray-400 w-[400px] py-2 px-8 rounded-md mb-3' />
          </div>
          <div className='mt-5 max-w-min mx-auto'>
            <p className='text-dark font-[500] text-[14px] mb-2'>Phone Number *</p>
            <input placeholder='Enter Your Phone Number' type={"number"} value={phoneNumber} onChange={(e) => { if (e.target.value.length <= 10) setPhoneNumber(e.target.value) }} className='border border-gray-400 w-[400px] py-2 px-8 rounded-md mb-3' />
          </div>
          <div className='mt-5 max-w-min mx-auto'>
