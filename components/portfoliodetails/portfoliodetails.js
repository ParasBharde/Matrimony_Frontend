  ...
  return (
    <>
      {/* <div class="container_card container my-12 mx-auto px-4 md:px-10">
        <div class="flex flex-wrap -mx- lg:-mx-2 w-10/12">
          <div class="cards flex overflow-hidden bg-white px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4 ">
            <article class="  ">
              <a href="#" className="relative">
                ...
                />
                  <svg
                  style={{backgroundColor:"rgba(0, 0, 0, 0.3)",width:'30',height:'25',top:"10",right:"10", }}
