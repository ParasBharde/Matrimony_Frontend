...
const Portfoliodetails = ({ history }) => {
  ...
  return (
    <>
      <div class="container_card grid lg:grid-cols-4">
        {profiles.length > 0 &&
          profiles.map((itms => {
            console.log("itmssss", itms.id);
            return (
              <>
                <div  class="max-w-xs mx-9 mb-2">
                  <div className="cards">
                    <Link
                      // href="/portfolio/portfolioprofile/"
                      href= {{
                        pathname: '/portfolio/portfolioprofile/',
                        query: { itms: itms.attributes },
                      }}
                      className="relative"
                    >
                      <Image
                        ...
                        src={profile}
                        // src={`https://localhost:1337.com${itms.attributes.profile_photo.data[0].attributes.url}`}
