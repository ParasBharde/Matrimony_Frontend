  ...
  return (
    <>
      ...
      router.pathname === "/likedprofile/[id]" ? (
        ...
        <div className="footer_main bg-main flex flex-wrap justify-between items-center px-20">
          <p className="text-white text-base py-2 max-md:order-2 max-md:mt-4">
            Copyright © Trichy Vayalur Road Reddy Trust All rights reserved.
            Theme Anews by themeuniver
          </p>
          <div className="flex justify-between text-white items-center max-md:order-1 max-sm:order-1 max-md:mt-2 max-sm:text-center">
            <i className="fa-brands fa-facebook mx-3"></i>
            <i className="fa-brands fa-twitter mx-3"></i>
            <i className="fa-brands fa-instagram mx-3"></i>
          </div>
